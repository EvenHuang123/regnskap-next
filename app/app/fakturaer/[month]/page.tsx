        ...
        <div style={{ maxWidth:760, margin:'0 auto' }}>
          ...
          {pageLoading ? (
            ...
            <div style={{ background:C.navyL, border:`1px dashed ${C.border}`, borderRadius:12, padding:'48px 24px', textAlign:'center' }}>
              ...
              <a href="/app/admin/test-parsing" style={{ display:'inline-block', marginTop:20, padding:'9px 20px', background:C.white, color:C.navy, borderRadius:8, fontSize:13, fontWeight:700, textDecoration:'none' }}>
                Last opp faktura
              </a>
            </div>
          ) : (
          ...
          {!pageLoading && fakturaer.length > 0 && (
            <div style={{ marginTop:24, textAlign:'center' }}>
              <a href="/app/admin/test-parsing" style={{ color:C.grayD, fontSize:13, textDecoration:'none' }}>
                + Last opp ny faktura
              </a>
            </div>
          )}
